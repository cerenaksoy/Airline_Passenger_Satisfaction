# -*- coding: utf-8 -*-
"""
Created on Sat Feb 11 15:37:51 2023
...
dc = DecisionTreeClassifier(criterion= "entropy", splitter= "random", max_depth=None,
                            max_features= None, random_state=2, class_weight=None)
dc.fit(x_train, y_train)
y_predict = dc.predict(x_test)

print('Test Accuracy of Decision Tree: {:.2f}'.format(dc.score(x_test, y_test)))
